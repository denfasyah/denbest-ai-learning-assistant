...
const WorkspaceTabs = () => {
  ...
  return (
    <div className="flex items-center gap-1 p-1 bg-white/2 rounded-2xl border border-white/5 w-full overflow-x-auto custom-scrollbar-hide whitespace-nowrap">
      {tabs.map((tab) => {
        const Icon = tab.icon;
        ...
        return (
          <button
            ...
            className={`
              flex items-center gap-2 rounded-xl px-4 py-2.5 text-[10px] font-black uppercase tracking-widest transition-all duration-300
              ${isActive
