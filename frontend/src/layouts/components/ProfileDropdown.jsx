...
const ProfileDropdown = ({ user, onLogout }) => {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="absolute right-0 mt-4 w-64 overflow-hidden rounded-4xl border border-white/10 bg-[#0B1120] shadow-2xl animate-in fade-in slide-in-from-top-4 duration-300 z-50">
          ...
          <div className="p-3">
            ...
            >
              <div className="h-5 w-10 flex items-center justify-center rounded-xl bg-indigo-500/10 group-hover:bg-indigo-500/20 transition-colors">
            ...
            <Link
              ...
              className="flex items-center gap-4 px-4 py-3 rounded-2xl text-slate-400 hover:text-white hover:bg-white/5 transition-all group"
            >
              <div className="h-5 w-10 flex items-center justify-center rounded-xl bg-violet-500/10 group-hover:bg-violet-500/20 transition-colors">
