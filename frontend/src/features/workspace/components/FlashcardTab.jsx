    ...
    return (
      <div className="w-full h-full flex flex-col items-center justify-center py-20 bg-white/5">
        ...
        <h2 className="text-2xl font-black text-white tracking-tight mb-3">
          AI sedang meracik materi...
        </h2>
        <p className="text-slate-500 font-medium mb-1">
          Aiden sedang membaca dokumen dan membuat flashcard terbaik buat kamu
        </p>
        <p className="text-[10px] font-black text-indigo-400 uppercase tracking-widest mb-8">
          Estimasi: 15–30 detik
        </p>

        <div className="w-64 h-2 bg-white/5 rounded-full overflow-hidden relative">
          <div className="absolute inset-0 bg-linear-to-r from-indigo-500 to-violet-500 w-full -translate-x-full animate-[progress_2s_ease-in-out_infinite]"></div>
        </div>
    ...
    return (
      <div className="w-full max-w-5xl mx-auto space-y-8 pb-12 animate-in fade-in duration-500">
        <Card className="p-6 border-white/10 bg-white/5 backdrop-blur-xl rounded-3xl">
          ...
          <div className="mt-10 flex flex-col items-center justify-center min-h-55 text-center">
            ...
            <p className="text-sm font-medium text-slate-500 max-w-xs leading-relaxed">
              Klik <span className="text-indigo-400 font-bold">Generate</span>{" "}
              di atas untuk membuat flashcard otomatis dari dokumen ini
              menggunakan AI.
            </p>
          </div>
        </Card>
        ...
        <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="text-base font-black text-white tracking-tight leading-none">
                ...
                <span className="text-slate-600">/ {flashcards.length}</span>
              </h2>
          ...
          <div className="flex flex-wrap items-center gap-4">
            <Button
              ...
              title={
                isShuffleLocked
                  ? "Tidak bisa shuffle saat review sedang berjalan"
                  : "Acak urutan kartu"
              }
            >
              Shuffle
      ...
      <div className="relative group max-w-2xl mx-auto py-4">
        <div style={cardContainerStyle}>
          ...
          >
            ...
            <div
              style={faceStyle}
              className="group-hover:border-indigo-500/30 transition-colors"
            >
            ...
            <div style={backFaceStyle}>
              ...
              <div
                className="absolute bottom-8 left-0 w-full px-8 flex justify-center gap-3"
